...
object SessionStore {
    ...
    fun saveSession(otherUserId: Long, state: RatchetState, password: String? = null) {
    ...
    fun loadSession(otherUserId: Long, password: String? = null): RatchetState? {
        val pw = password ?: Settings.storagePassword ?: return null
        val raw = Db.loadSessionBlob(pw, otherUserId) ?: return null
        return json.decodeFromString(raw)
    }

    fun loadSessions(password: String? = null): Map<Long, RatchetState> {
